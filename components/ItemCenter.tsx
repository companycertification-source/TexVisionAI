                ...
                <div className="space-y-4">
                   ...
                   <div>
                      ...
                      <input 
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                        placeholder="e.g. Electrodes, Wire"
                      />
                   </div>
                   ...
                   {/* Main Reference Image (Catalogue Cover) */}
                   <div>
                       <label className="block text-sm font-bold text-gray-700 mb-1">Catalogue Cover Image</label>
                       ...
                       {editForm.reference_image_url ? (
                         ...
                         <label className="flex flex-col items-center justify-center gap-2 h-32 px-4 py-2 bg-gray-50 border border-gray-300 border-dashed rounded-lg hover:bg-blue-50 transition cursor-pointer">
